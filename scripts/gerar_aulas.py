...
BASES = {
    "glossario": "https://raw.githubusercontent.com/icasine/glossariocoop/main/glossario.json",
    "calendario": "https://raw.githubusercontent.com/icasine/calendarioucoop/main/eventos.json",
    "acervo": "https://raw.githubusercontent.com/icasine/acervo-cooperativismo/main/artigos.json",
}
avisos = []
...
for n, linha in enumerate(csv.DictReader(io.StringIO(texto_csv)), start=2):
    ...
    if tipo == "referencia":
        ...
        if base not in BASES or not ids:
            avisos.append(f"{onde}: referência precisa de base (glossario, calendario ou acervo) e ref_id, ignorada"); continue
